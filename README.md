...
Les commandes `/where` (Anglais), `/tesou` (Français), `/wobistdu` (Allemand) et `/doko` (Japonais romaji) seront disponibles sur votre serveur et vous permettront d'afficher les conditions de spawn pour un Pokémon donné.
